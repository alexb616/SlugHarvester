...
Basic enumeration:
```bash
python3 wp_user_enum_api_check.py -u [https://target-site.com](https://target-site.com)
```
Enumerate and save slugs to a file:
```bash
python3 wp_user_enum_api_check.py -u [https://target-site.com](https://target-site.com) -o usernames.txt
```
